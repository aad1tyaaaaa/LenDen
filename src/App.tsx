...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-secondary via-black to-primary/5">
      {/* Header - Hidden on larger screens when sidebar is visible */}
      <header className="sticky top-0 z-50 bg-gradient-to-r from-primary to-primary/80 text-primary-foreground shadow-xl w-full lg:hidden">
      ...
      <div className="flex">
        ...
        <aside className="hidden lg:flex lg:flex-col lg:fixed lg:left-0 lg:top-0 lg:h-screen lg:w-64 lg:bg-gradient-to-r lg:from-primary lg:to-primary/90 lg:text-primary-foreground lg:shadow-2xl lg:z-40">
          ...
          <div className="p-6 border-b border-white/10">
            <div className="flex items-center space-x-3">
              <img src="/logo.jpg" alt="LenDen Logo" className="w-12 h-12" />
              <div>
              ...
              return (
                <button
                  ...
                  className={`w-full flex items-center space-x-3 p-3 rounded-xl transition-all duration-200 ${
                    isActive
                      ? 'bg-white/20 text-white border-l-4 border-orange'
          ...
          <div className="p-4 border-t border-white/10">
            <div className="flex items-center space-x-3 p-3 bg-white/10 rounded-xl">
              <img src="/pfp.png" alt="User Profile" className="w-10 h-10 rounded-full object-cover" />
              <div>
        ...
        {/* Main Content */}
        <main className={`
          flex-1 w-full pb-24 lg:pb-8 transition-all duration-300
          ${'lg:ml-64'} 
          max-w-md mx-auto lg:max-w-4xl xl:max-w-6xl p-4 sm:p-6
        `}>
          <div className="bg-black/70 lg:bg-white/70 lg:backdrop-blur-sm rounded-2xl shadow-lg border border-white/50 p-4 sm:p-6 lg:p-8">
            {renderContent()}
          </div>
        </main>
      </div>

      {/* Voice Button - Only visible on Home page and mobile */}
      {currentPage === 'home' && (
      ...
      <nav className="fixed bottom-0 left-0 right-0 bg-black/90 backdrop-blur-md shadow-2xl border-t border-orange/20 lg:hidden">
